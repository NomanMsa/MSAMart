...
const STAR_IMAGE = Icons.star;
const HEART_IMAGE = Icons.heart;
const ROCKET_IMAGE = Icons.rocket;
const BELL_IMAGE = Icons.bell;
...
export default class SwipeRating extends Component {
  ...
  async componentDidMount() {
    try {
      const STAR_IMAGE = await Icons.star;
      const HEART_IMAGE = await Icons.heart;
      const ROCKET_IMAGE = await Icons.rocket;
      const BELL_IMAGE = await Icons.bell;
