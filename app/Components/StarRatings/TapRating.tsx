...
export default class TapRating extends Component {
  ...
  render() {
    ...
    const { count, reviews, showRating, reviewColor, reviewSize, showTitle, title, titleStyle, starStyle } = this.props
    const rating_array = []
    ...
    return (
      <View style={styles.ratingContainer}>
        <>{ showTitle &&
          <Text style={[styles.reviewText, {fontSize: reviewSize, color: reviewColor}, titleStyle]}>
            {title}
          </Text>
        }
        { showRating &&
