...
class TermsConditions extends Component {
  ...
  async componentDidMount() {
    if (this.props.TermsAndConditionData && this.props.TermsAndConditionData.length > 0) {
      this.setState({
        listData: this.props.TermsAndConditionData,
        QuestionaryData: this.props.TermsAndConditionData[0].TopicQuestions
      })
    } else {
  ...
  onSuccessFetchHelpData = (data) => {
    ...
    if (data.model && data.model.length > 0) {
      ...
      this.props.UpdatePolicyStaticData({
        ...
        TermsAndConditionData: data.model,
      })
    }
  }
    ...
    return (
      <View style={[styles.headerContainer]}>
        ...
        <View style={[styles.loginHeaderTextContainer]}>
          <Text style={styles.headerText}>{Strings.TermsConditions}</Text>
        </View>
      </View>
    );
  };
